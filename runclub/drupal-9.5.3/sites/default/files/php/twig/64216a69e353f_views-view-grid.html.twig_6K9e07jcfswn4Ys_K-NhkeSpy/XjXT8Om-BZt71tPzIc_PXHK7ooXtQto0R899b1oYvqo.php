...
/* themes/january_theme/templates/views/views-view-grid.html.twig */
class __TwigTemplate_27316e106db212cc45322f73ee67f541 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        if ((twig_get_attribute($this->env, $this->source, ($context["options"] ?? null), "alignment", [], "any", false, false, true, 27) == "vertical")) {
            // line 28
            echo "  ";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->attachLibrary("january/layout-views-grid-vertical"), "html", null, true);
            echo "
";
        } else {
            // line 30
            echo "  ";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->attachLibrary("january/layout-views-grid-horizontal"), "html", null, true);
            echo "
";
        }
        // line 32
...
";
    ...
    {
        return "themes/january_theme/templates/views/views-view-grid.html.twig";
    }
    ...
    {
        return new Source("", "themes/january_theme/templates/views/views-view-grid.html.twig", "C:\\xampp\\htdocs\\runclub\\drupal-9.5.3\\themes\\january_theme\\templates\\views\\views-view-grid.html.twig");
    }
