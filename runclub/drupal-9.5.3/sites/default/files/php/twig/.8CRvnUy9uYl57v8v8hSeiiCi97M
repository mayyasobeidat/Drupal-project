...
class __TwigTemplate_31feb4e0fb8f6df1fb928a96f30ec116 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["menu_level"] ?? null) == 0) && twig_get_attribute($this->env, $this->source, $context["item"], "is_expanded", [], "any", false, false, true, 49))) {
  ...
  ";
    ...
    {
        return new Source("", "themes/thex/templates/navigation/menu.html.twig", "C:\\xampp\\htdocs\\runclub\\drupal-9.5.3\\themes\\thex\\templates\\navigation\\menu.html.twig");
    }
